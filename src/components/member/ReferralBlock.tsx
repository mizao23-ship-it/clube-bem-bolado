...
export default function ReferralBlock({ refCode }: Props) {
  ...
  return (
    <div className={styles.block}>
      <div className={styles.labelRow}>
        <div className={styles.label}>Seu link de indicação</div>
        <span className={styles.badgeAvailable}>Ilimitado 🚀</span>
      </div>
      ...
      <div className={styles.hint}>
        Convide quantos amigos quiser! Cada indicado conta para sua pontuação 🎯
      </div>
    </div>
  )
}
